...
namespace qSharp.test
{
    internal class QExpressions
    {
        ...
        {
            {
                ...
                new Dictionary<string, object>
                {
                    ...
                    {"(0b;1b;1b)", new[] {false, true, true}},
                    {"(0x02;0x02;0xff)", new byte[] {2, 2, 255}},
                    {"(2h;2h;3h)", new short[] {2, 2, 3}},
                    {"(2i;2i;3i)", new[] {2, 2, 3}},
                    {"2 2 3", new long[] {2, 2, 3}},
                    {"(2j;2j;3j)", new long[] {2, 2, 3}},
                    {"(6.5e; 8.5e)", new[] {6.5f, 8.5f}},
                    {"3.233 6.46", new[] {3.233, 6.46}},
                    ...
                    {"(2;`bcd;\"0bc\";5.5e)", new object[] {1, "bcd", "0bc".ToCharArray(), (float) 5.5}},
                    {"(enlist 2h; 2; enlist 3j)", new object[] {new short[] {1}, 2, new long[] {3}}},
                    ...
                    {"``", new[] {"", ""}},
                    {
                        ...
                        new object[]
                        {
                            "quick".ToCharArray(), "brown".ToCharArray(), "fox".ToCharArray(), "jumps".ToCharArray(),
                            "over".ToCharArray(), "a lazy".ToCharArray(), "dog".ToCharArray()
                        }
                    },
                    {
                        "(\"quick\"; \"brown\"; \"fox\")",
                        new[] {"quick".ToCharArray(), "brown".ToCharArray(), "fox".ToCharArray()}
                    },
                    {
                    ...
                    {"1 2!`abc`cdefgh", new QDictionary(new[] {1, 2}, new[] {"abc", "cdefgh"})},
                    {
                        ...
                        new QDictionary(new[] {"abc", "def", "gh"},
                            new QTable(new[] {"one", "two"}, new object[] {new[] {1L, 2L, 3L}, new[] {4L, 5L, 6L}}))
                    },
                    {
                        "(`x`y!(`a;2))", new QDictionary(new[] {"x", "y"},
                            new object[] {"a", 2})
                    },
                    {
                    ...
                    },
                    {
                        ...
                        new QTable(new[] {"name", "iq", "grade"},
                            new object[]
                            {new[] {"Dent", "Beeblebrox", "Prefect"}, new[] {98, 42, 126}, new[] {'a', ' ', 'c'}})
                    },
                    {
                        ...
                        new QTable(new[] {"name", "iq", "fullname"},
                            new object[]
                            {
                                new[] {"Dent", "Beeblebrox", "Prefect"}, new[] {98, 42, 126},
                                new object[]
                                {
                                    "Arthur Dent".ToCharArray(), "Zaphod Beeblebrox".ToCharArray(),
            ...
            },
            {
                ...
                new Dictionary<string, object>
                {
                    ...
                    },
                    {
                        ...
                        new QTable(new[] {"name", "iq", "grade"},
                            new object[]
                            {new[] {"Dent", "Beeblebrox", "Prefect"}, new long[] {98, 42, 126}, new[] {'a', ' ', 'c'}})
                    },
                    {
                        "flip `name`iq`fullname!(`Dent`Beeblebrox`Prefect;98 42 126;(\"Arthur Dent\"; \"Zaphod Beeblebrox\"; \"Ford Prefect\"))",
                        new QTable(new[] {"name", "iq", "fullname"},
        ...
        public QExpressions(Dictionary<string, string> files)
        {
            foreach (var pair in files)
            {
                ...
                using (expressionsFile)
                {
                    while (true)
                    {
                        var query = expressionsFile.ReadLine();
                        var expression = expressionsFile.ReadLine();
        ...
        public object GetReferenceObject(string version, string key)
        {
            ...
            {
                Console.Error.WriteLine("Cannot retrieve key: {0}", key);
                throw e;
            }
        }
